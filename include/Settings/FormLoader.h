...
public:
    ...
    void LoadMiscForms(RE::TESDataHandler* dataHandler)
    {
        ...
        inWeatherReach->data.comparisonValue.f      = 1.0f;
        inWeatherReach->data.functionData.function  = RE::FUNCTION_DATA::FunctionID::kIsPlayerInRegion;
        inWeatherReach->data.functionData.params[0] = utility->WeatherReach;

        auto notInWeatherMountains                         = new RE::TESConditionItem;
        notInWeatherMountains->next                        = inWeatherReach;
        notInWeatherMountains->data.comparisonValue.f      = 0.0f;
        notInWeatherMountains->data.functionData.function  = RE::FUNCTION_DATA::FunctionID::kIsPlayerInRegion;
        notInWeatherMountains->data.functionData.params[0] = utility->WeatherMountains;

        auto notInWeatherSnow                         = new RE::TESConditionItem;
        notInWeatherSnow->next                        = notInWeatherMountains;
        notInWeatherSnow->data.comparisonValue.f      = 0.0f;
        notInWeatherSnow->data.functionData.function  = RE::FUNCTION_DATA::FunctionID::kIsPlayerInRegion;
        notInWeatherSnow->data.functionData.params[0] = utility->WeatherSnow;

        auto reachCond  = new RE::TESCondition;
        reachCond->head = notInWeatherSnow;
